...
return [
    ...
    */
    'user_models' => [
        'users' => \Modules\Users\Models\User::class,
    ],
    ...
    */
    'models' => [
        ...
        'role' => \Modules\Roles\Models\Role::class,

        'permission' => \Modules\Roles\Models\Permission::class,
    ...
    'middleware' => [
        ...
        'handlers' => [
            ...
            'redirect' => [
                ...
                'message' => [
                    'key' => 'middleware',
                    'content' => 'У вас нет прав на просмотр этой страницы'
                ],
            ]
        ]
    ],
